...
const ProductCard = ({ id, img, name, price, sale}: IProduct) => {
    ...
    <Image   
     className="w-full"
       ...
       {sale && (
        <div className="bg-red-600 inline-block abosulte top-0 left-0 text-[14px] text-white
       ...
       <div className="absolute top-0 left-0 w-full h-full bg-[#00000050] opacity-0
        transition-opacity duration-500 group-hover::opacity-100 cursor-pointer ">
         ...
         <div className="bg-white w-[50px] h-[50px]  text-[26px] grid place-items-center" onClick={addToCart}
