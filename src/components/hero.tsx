...
const Hero = () => {
  return (
    <div className='container relative pt-16'>
     ...
     <div className='hidden sm:block absolute top-[50%] left-[50%] translate-x-[-50%] 
     ...
     lg:space-y-6 xl:w-[400px] xl:h-[300px] p-6 xl:space-y-8'>
       ...
       New Lipstic for you girl
        </h2>
        <p className='text-gray-600 text-[14px] xl:text-[16px]'>
         Lorem , ipsum dolor sit amet consectetur.
        </p>
        <button className='bg-[#333] uppercase text-white text-[12px]
         lg:text-[16px] py-2 xl:py-4 px-8 rounded-md hover:bg-accent'>
      Shop Now
        </button>
     </div>
